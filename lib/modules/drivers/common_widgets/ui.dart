...
class Ui {
  ...
  /// Success Snackbar
  static GetSnackBar SuccessSnackBar({String title = 'Success', String? message, double? maxWidth, int? seconds = 2}) {


    Get.log("[$title] $message");

    return GetSnackBar(
      titleText: Text(title.tr, style : Get.textTheme.headline6!.apply(color: Colors.white)),
      messageText: Text(message!, style: Get.textTheme.subtitle2!.apply(color: Colors.white)),
  ...
  /// Error Snackbar
  static GetSnackBar ErrorSnackBar({String title = 'Error', String? message, double? maxWidth}) {
    ...
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6!.apply(color: Colors.white)),
      messageText: Text(message!, style: Get.textTheme.bodyText2!.apply(color: Colors.white)),
      snackPosition: SnackPosition.BOTTOM,
      maxWidth:  maxWidth,
      margin: const EdgeInsets.all(20),
  ...
  /// Alert Snackbar
  static GetSnackBar AlertSnackBar({String title = 'Alert', String? message, double? maxWidth}) {
